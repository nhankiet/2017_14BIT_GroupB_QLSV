...
<body>
	...
	?>
  	...
  	<?php
		...
		{
			$sl = $_SESSION["sl"];
			$str_themsinhvien = "insert into user(HoTen, Phai, NgaySinh, DiaChi, SoDienThoai, Email, MatKhau, MaLop, TinhTrang, LoaiUser) values";
			for($i=1; $i<=$sl; $i++)
			{
				$hoten = $_POST["hoten".$i];
				$phai = $_POST["phai".$i];
	...
	$(document).ready(function(){
		var sl = $("#sldong").val();
		$.post("admin-themsinhvien-ajax.php", { sl:sl }, function(data, status){
			if(status=="success")
			{
   	...
   	<div class="container-fluid">
 		...
 		<div class="row">
  		...
  		<hr><hr><hr>
   		<div class="row">
   			<div class="col-lg-12">
				<form class="" action="admin-themsinhvien.php" method="post">

...
<title>Thêm chuyên cần - Admin</title>
...
<!--						<th><label>Chọn khóa học của lớp</label></th>-->
                </thead>
                <tbody>
                    ...
                    <tbody>
                        <td>
                            <select name='masv' id="js-masinhvien">
                                ...
                                {
//                                if($khoa['MaLop'] == $lopdautien['MaLop'])
                                    {?>
                        ...
                        <td>
                            <select name='makhoa' id="js-makhoahoc">
                                <?php $str_laymakh = "select * from khoa WHERE MaLop = '{$lopdautien["MaLop"]}'";
...
//                                if($khoa['MaLop'] == $lopdautien['MaLop'])
                        ...
                        <td><input id="js-thoidiem" type="date" value="2017-01-01" required></td>
...
$(document).ready(function() {
	$(".malop").change(function() {
        ...
        $.ajax({
            url: "admin-themchuyencan-loadkhoavasinhvien.php",
            data: {
                malop: malopvalue
            }
        })
...
//                console.log(item);
    ...
    $("#js-add").click(function (e) {
        ...
        if (confirm('Bạn có chắc muốn thêm chuyên cần?')) {
            $.post({
                url: "admin-themchuyencan-ajax.php",
                data: {

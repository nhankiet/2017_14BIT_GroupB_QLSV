<?php
	...
	{	
		...
		if(is_null($row3[DiemTongKet]))
		{
			echo "<td><input type='number' name='diemtk$i' class='input-lg' min='0' max='10' step='0.25'></td>";
		}
		else
		{
			echo "<td><input type='number' name='diemtk$i' class='input-lg' min='0' max='10' step='0.25' value='$row3[DiemTongKet]' readonly></td>";
		}
